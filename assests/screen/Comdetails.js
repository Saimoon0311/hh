...
export default class Comdetails extends Component{
  constructor(props){
 super(props);
 this.state={ 
 list:[],
          ...
          renderItem={({item})=>{
             return(
              <View style={styles.hh}>
               ...
               <Text style={styles.itemtext}><Text style={{fontWeight:"bold"}}>Company Name : </Text>    {item.cname}</Text>
                <Text style={styles.itemtext}><Text style={{fontWeight:"bold"}}>Email : </Text>    {item.address}</Text>
                <Text style={styles.itemtext}><Text style={{fontWeight:"bold"}}>Company Number :  </Text>     {item.number}</Text>
